...
ui_print "[AnyMeta] Executing boot-completed.sh..." > /dev/kmsg
...
# ui_print "[AnyMeta] System boot completed successfully." > /dev/kmsg

# ---------------------------------------------------------

echo "[AnyMeta] boot-completed.sh completed." > /dev/kmsg
